...
keys! {
    ...
    BLEACH_ML_PER_GAL = "bleach_ml_per_gal",
    BLEACH_BOTTLES_PER_HOUSEHOLD = "bleach_bottles_per_household",
    BLEACH_REPLACE_MONTHS = "bleach_replace_months",
    ...
    COOKING_FUEL_LB_PER_PERSON_DAY = "cooking_fuel_lb_per_person_day",
    FUEL_CANISTER_LB = "fuel_canister_lb",
    COOKING_FUEL_MIN_CANISTERS = "cooking_fuel_min_canisters",
    ...
    FORMULA_POWDER_OZ_PER_DAY = "formula_powder_oz_per_day",
    BABY_SUPPLY_MIN_DAYS = "baby_supply_min_days",
    NURSING_PAD_BOXES = "nursing_pad_boxes",
    MANUAL_PUMPS_PER_NURSING_INFANT = "manual_pumps_per_nursing_infant",
    PET_FOOD_MIN_DAYS = "pet_food_min_days",
    DOG_FOOD_LB_PER_DAY = "dog_food_lb_per_day",
    CAT_FOOD_LB_PER_DAY = "cat_food_lb_per_day",
    SMALL_PET_FOOD_LB_PER_DAY = "small_pet_food_lb_per_day",
    RX_DAYS_ON_HAND = "rx_days_on_hand",
    RX_EMERGENCY_REFILL_DAYS = "rx_emergency_refill_days",
    COOLER_HOLD_DAYS = "cooler_hold_days",
    RX_POWER_MIN_DAYS = "rx_power_min_days",
    INSULIN_ROOM_TEMP_DAYS = "insulin_room_temp_days",
    INSULIN_ROOM_TEMP_MIN_F = "insulin_room_temp_min_f",
    INSULIN_ROOM_TEMP_MAX_F = "insulin_room_temp_max_f",
    ...
    FRIDGE_THERMOMETER_PAIRS = "fridge_thermometer_pairs",
    FOOD_SAFE_MAX_F = "food_safe_max_f",
    FOOD_UNSAFE_HOURS = "food_unsafe_hours",
    ...
    BATTERY_PACK_DAYS = "battery_pack_days",
    POWER_STATION_MAX_UNITS = "power_station_max_units",
    POWER_STATION_UPGRADE_DAYS = "power_station_upgrade_days",
    GENERATOR_MIN_DAYS = "generator_min_days",
    GENERATOR_MIN_DAYS_WELL = "generator_min_days_well",
    SOLAR_PANEL_MIN_DAYS = "solar_panel_min_days",
    FUEL_CAN_GAL = "fuel_can_gal",
    ...
    CASH_DEFAULT_USD = "cash_default_usd",
    ...
    TOILET_PAPER_PERSON_DAYS_PER_ROLL = "toilet_paper_person_days_per_roll",
    ...
    BLEEDING_KITS_PER_HOUSEHOLD = "bleeding_kits_per_household",
    BLEEDING_KIT_LIFE_SAFETY_P10 = "bleeding_kit_life_safety_p10",
    FAN_MAX_INDOOR_F = "fan_max_indoor_f",
    ROOM_THERMOMETERS_PER_HOUSEHOLD = "room_thermometers_per_household",
    ...
    SLEEPING_BAGS_MIN_DAYS = "sleeping_bags_min_days",
    ...
    PEOPLE_PER_BEDROOM = "people_per_bedroom",
    ESCAPE_LADDER_LOWEST_FLOOR = "escape_ladder_lowest_floor",
    ESCAPE_LADDER_HIGHEST_FLOOR = "escape_ladder_highest_floor",
    CO_ALARM_REPLACE_YEARS = "co_alarm_replace_years",
    EXTINGUISHERS_PER_FLOOR = "extinguishers_per_floor",
    HOME_FIRES_PER_100_HOUSEHOLDS = "home_fires_per_100_households",
    HOME_FIRES_REPORTED_SHARE = "home_fires_reported_share",
