...
Derived from `docs/research/risk-model.md` (the research report) and `docs/DESIGN.md` §4. Each
workstream keeps to its own heading so the parts merge cleanly: `## Hazard rates` (rr-hazards),
