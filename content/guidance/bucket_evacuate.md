...
**What to avoid.** Many people wait to check with others before they act on a warning.[^wood_2018_milling] Always follow the instructions of local officials, and leave early enough to avoid being trapped by bad weather.[^ready_gov_evacuation] {if:home:apartment_high_rise}In a tall building, do not count on the elevator. It can stop when the power goes out, so leave early if you need it.[^nws_hurricane_safety_brochure][^ready_gov_hurricanes_2014]{/if} {if:home:mobile_home}Do not stay in a mobile home through a hurricane or tornado warning, even if it is tied down.[^nws_hurricane_safety_brochure][^ready_gov_tornadoes_2014][^noaa_spc_tornado_safety]{/if} Never walk or drive through floodwater. Six inches of moving water can knock you down.[^ready_gov_floods]
